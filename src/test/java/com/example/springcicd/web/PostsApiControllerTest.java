...
public class PostsApiControllerTest {
    ...
    @Test
    public void Posts_단건조회된다() throws Exception {
        //given
        Posts savedPosts = postsRepository.save(Posts.builder()
                .title("title")
                .content("content")
        ...
        HttpEntity<Long> requestEntity = new HttpEntity<>(selectId);

        //when

        ResponseEntity<PostsResponseDto> responseEntity = restTemplate
                .exchange(url, HttpMethod.GET, requestEntity, PostsResponseDto.class);

        assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(responseEntity.getBody().getId()).isEqualTo(selectId);
    }
}
